...
class Downloader:
    def __init__(self):
        ...
        self.window.geometry("844x400")
        self.progress_bar =ttk.Progressbar(self.window, orient="horizontal", maximum=1000, length=300, mode="determinate")
        self.progress_bar.pack()
        self.window.mainloop()

    def browse_file(self):
        saveto = filedialog.asksaveasfilename(initialdir=self.url_entry.get().split("/")[-1].split("?")[0])
        self.saveto=saveto
